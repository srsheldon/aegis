...
if ( protocol === 'https' ) {
	...
	if ( ! fs.existsSync( key ) || ! fs.existsSync( certificate ) ) {
		try {
			...
			execSync(
				`openssl req -newkey rsa:2048 -new -nodes -x509 -days 365 -keyout ./certs/key.tmp.pem -out ${ certificate } -subj "/C=US/ST=Delaware/L=Wilmington/O=Baz/OU=Frontend/CN=localhost"`,
				execOptions
			);
